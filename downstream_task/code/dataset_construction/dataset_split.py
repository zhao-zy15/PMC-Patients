...
dev_PMIDs = json.load(open("../../meta_data/dev_PMIDs.json", "r"))
test_PMIDs = json.load(open("../../meta_data/test_PMIDs.json", "r"))
...
relevant_patient2patient = json.load(open("../../../PMC-Patients_collection/meta_data/patient2patient_similarity.json", "r"))
...
relevant_patient2article = json.load(open("../../../PMC-Patients_collection/meta_data/patient2article_relevance.json", "r"))
PAR_train = {}
PAR_dev = {}
PAR_test = {}
