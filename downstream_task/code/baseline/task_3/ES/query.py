...
class search_thread(Thread):
    ...
    def run(self):
        ...
        # If needs to return score.
        #result_ids = [(x['_id'], x['_score']) for x in results['hits']['hits'][1:]]
        ...
        q.put((RR, precision, recall_1k, recall_10k, self.patient_id, result_ids))   
...
#json.dump(result_ids, open("../full_patient2patient_retrieved_test.json", "w"), indent = 4)
